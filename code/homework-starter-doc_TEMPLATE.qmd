...
**total mass is positively correlated with leaf dry weight (pearsons r=0.46)**  

**shoot mass and otal mass are strongly positively correlated (pearsons r=0.902)**  

**root mass and shoot mass are positively correlated (pearsons r=0.553)**
...
**plants with larger biomass seem to have larger ranges, grindelia has highest biomass, acmison has lowest biomass**
...
**the drought stressed plants have lower biomass than the plants that were well watered, makes sense based on how plants work**
...
**it seems to be relatively positively correlated, that the larger the leaf area the greater the biomass, visually it doesnt seem correlated, but statistically it is possible**
...
**LOOK AT THE DIAGNOSTICS AGAIN FOR THE BEST MODEL**
...
**reference for species_name:** **species_name**  

Interpret the model estimates for the:  

- intercept: **acmispon glaber in drought stressed treatment when SLA=0**  
- SLA slope: **across drought treatments and species, with each 1 unit increase in SLA, we expect an increase in total mass of -0.00025 WHICH MEANS WITH THE ESTIMATE AND STANDARD ERROR THERE IS NO EFFECT OF SLA ON TOTAL MASS**  
- well watered estimate: **across species and SLA, well watered plants tend to be 0.12 +- (figure out how to write +- in text) 0.02 g heavier than drought stressed plants**    
